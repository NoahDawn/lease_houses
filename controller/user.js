...
const login = async (username, password) => {
    ...
    const sql = `select id, username, realname, picture, phone from userms where username=${username} and password=${password} `
...
const register = async (userData = {}) => {
    ...
    const picture = 'http://127.0.0.1:8000/picture/user/DefaultAvatar.jpg'
    const money = 0.00
...
//     const sql = `select username, realname, phone, picture from userms where id='${id}' `
//     const userData = await exec(sql)
//     return userData[0] || {}
// }
